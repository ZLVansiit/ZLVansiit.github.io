...
export function buildMomentsPosts(): MomentPost[] {
  return [
    ...
    ,
    {
      ...
      content: '这轮AI革命，本质是解放人类大脑，解决的是注意力稀缺的问题。前几轮革命，工业革命和互联网革命，都在解放人类体力和劳力。互联网浪潮中的淘汰者们，被我们这一代程序员革命，他们失业找出路然后被遗忘。所以，当风暴有一次来临，只是历史的重演，然后螺旋上升。作为这一轮的“纺织工人”，心情复杂。不管动机和目标如何，敢于革自己的命，本身就是勇气的行为。如果历史有一天，被别人革命了，那就不会发出一丝声音。希望大家都好！'
    }
  ]
}
